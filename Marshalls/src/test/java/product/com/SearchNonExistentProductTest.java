 ...
 * @author Admin
 */
public class SearchNonExistentProductTest {

    private WebDriver driver;

    public SearchNonExistentProductTest() {
    }
    ...
    @Test
    public void testSearchNonExistentProduct() throws Exception {
        ...
        driver.findElement(By.id("search-text-input")).sendKeys("tylenol");
        driver.findElement(By.id("site-search-form")).submit();
        driver.get("https://www.marshalls.com/us/store/shop/noresults/?_dyncharset=utf-8&initSubmit=true&Ntt=tylenol&qfh_sch=Search");
        driver.close();
